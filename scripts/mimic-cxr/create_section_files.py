...
def main(args):
    ...
    for p_grp in p_grp_folders:
        ...
        for p in tqdm(p_folders):
            ...
            for s in studies:
                ...
                idx = -1
                for sn in ('findings','impression','indication','comparison','technique','history','examination','last_paragraph'):
    ...
    if len(patient_studies) > 0:
        ...
        with open(output_path / 'mimic_cxr_sectioned.csv', 'w') as fp:
            ...
            # write header
            csvwriter.writerow(['study', 'findings','impression','indication','comparison','technique','history','examination','last_paragraph'])
